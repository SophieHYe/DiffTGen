...
public class InitialParams {
	...
	public static boolean init(String bugid, String repairTool, List<Modification> modList, List<MethodToBeInstrumented> oracleMedInstruList, int trials, int timeout, String outputRootdPath) {

		String testid = bugid + "_" + repairTool.toLowerCase();
		
		//Set up the output directory
		File output_root_dir = new File(outputRootdPath);
